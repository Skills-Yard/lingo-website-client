  ...
  return (
    <footer className="w-full flex gap-3 mb-2 select-none">
      ...
      <button
        ...
        className={`flex-grow flex items-center justify-center gap-2 py-3 rounded-2xl border-2 border-b-4 text-white font-extrabold text-sm shadow-md active:translate-y-0.5 transition-all cursor-pointer ${!hasActiveCommands
