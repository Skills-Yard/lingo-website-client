...
export function OnboardingLayout({
  ...
  return (
    <div className="relative flex min-h-screen flex-col overflow-hidden bg-[linear-gradient(180deg,var(--background)_0%,var(--surface)_100%)] text-[var(--foreground)]">
      ...
      {(resolvedStep !== undefined && resolvedStep <= 8) && (
      ...
      <div className="flex flex-col items-center mb-8 gap-6 mt-4">
        {showLogo && <LumiLogo variant="study" priority />}
      ...
      {showContinueButton && (
        <div className="fixed bottom-0 left-0 right-0 flex justify-center bg-gradient-to-t from-[var(--background)] via-[var(--background)] to-transparent p-4 sm:p-6">
