...
export default function Footer() {
  return (
    <footer className="fixed left-1/2 -translate-x-1/2 w-[calc(100%-2rem)] max-w-4xl bottom-5 rounded-3xl border border-border bg-card/90 backdrop-blur-md shadow-[0_8px_30px_rgb(0,0,0,0.08)] z-40 pb-[env(safe-area-inset-bottom)] transition-all duration-200">
